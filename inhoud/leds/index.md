...
This LED array is powered by [one 1050mA power source](https://www.mouser.be/ProductDetail/MEAN-WELL/LPC-60-1050?qs=O2yOKspD61CwHxEZesuS%2Fw%3D%3D) and [two 350mA power sources](https://www.mouser.be/ProductDetail/MEAN-WELL/APC-12-350?qs=DNaZHaGatO0h%2FjPDgBoC1g%3D%3D).
...
This LED array consists of two identical PCBs that are powered in parallel (see LEDs and PCB for schematics of the PCBs) [two 1400mA power sources](https://www.mouser.be/ProductDetail/MEAN-WELL/LPC-60-1400?qs=O2yOKspD61Aj4Vv%2BmwlI7Q%3D%3D) and [one 1050mA power source](https://www.mouser.be/ProductDetail/MEAN-WELL/LPC-60-1050?qs=O2yOKspD61CwHxEZesuS%2Fw%3D%3D).
...
This LED array is powered by one 200mA power source, [one 500mA power source](https://www.mouser.be/ProductDetail/RECOM-Power/RACT12-500?qs=gt1LBUVyoHnLAK5OjzGrww%3D%3D), and [one 1400mA power source](https://www.mouser.be/ProductDetail/MEAN-WELL/PCD-25-1400B?qs=%2F%2Bo%2FYLy8OFqnTDCUJjd14g%3D%3D).
...
The control is achieved by interrupting or allowing the current from the different power sources with a relay. This is controlled by a MOSFET, which in turn is controlled by an ESP32.
